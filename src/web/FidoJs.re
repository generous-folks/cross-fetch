...
// [@genType]
// let fromObservable = Fido_observable.fromObservable;
// [@genType]
// let toObservable = Fido_observable.toObservable;

// [@genType]
// let fromCallbag = Fido_callbag.fromCallbag;
// [@genType]
// let toCallbag = Fido_callbag.toCallbag;
...
//     Fido_operators.takeLast(1, source, (. signal) =>
//       switch (signal) {
//       | Start(x) => x(. Pull)
//       | Push(x) => resolve(. x)
//       | End => ()
